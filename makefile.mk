...
SNAPPY_INCLUDE_PATH=$(SRC_BASE_PATH)/third_party/snappy/include
...
SNAPPY_LIB_PATH=$(SRC_BASE_PATH)/third_party/snappy/lib
...
CXX=g++
CXXFLAGS+=-std=c++11
CPPFLAGS+=-I$(SRC_BASE_PATH) -I$(PROTOBUF_INCLUDE_PATH) -I$(SNAPPY_INCLUDE_PATH) -I$(LEVELDB_INCLUDE_PATH)
CPPFLAGS+=-I$(GLOG_INCLUDE_PATH) -I$(GFLAGS_INCLUDE_PATH)
CPPFLAGS+=-Wall -g -fPIC -m64 

LDFLAGS += -L$(PHXPAXOS_LIB_PATH) -L$(PHXSQL_LIB_PATH) -L$(PROTOBUF_LIB_PATH) -L$(LEVELDB_LIB_PATH) -L$(SNAPPY_LIB_PATH) 
LDFLAGS += -L$(GLOG_LIB_PATH) -L$(GFLAGS_LIB_PATH) -L$(GRPC_LIBE_PATH) -L$(OPEN_SSL_LIB_PATH) -L$(MYSQL_LIB_PATH)
